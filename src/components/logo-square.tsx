...
export default function LogoSquare({ size }: { size?: 'sm' | undefined }) {
  return (
    ...
    >
      <svg aria-label="Ícone de link" className="x1lliihq x1n2onr6" fill="current" height="16" role="img" viewBox="0 0 25 25" width="16">
        ...
        <line fill="none" stroke="#0f9d58" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="8.471" x2="15.529" y1="15.529" y2="8.471"></line></svg>
    </div>
  );
}