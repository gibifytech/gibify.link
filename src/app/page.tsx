...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-10 max-w-5xl mx-auto">
      ...
      <h1 className='text-6xl md:text-3xl'>Simplificando a maneira de você compartilhar seu conteúdo na internet.</h1>
      <p>
        O Gibify é a ferramenta ideal para influenciadores, criadores de conteúdo, empresas e qualquer pessoa que deseja otimizar sua presença online.
        É hora de simplificar a maneira como você compartilha seu conteúdo na web.
        Junte-se ao Gibify e crie seu link personalizado hoje mesmo!
      </p>
